...
After all, quality rating is a relatively subjective factor. Human-beings, even the experts have their limit in distinguish the tiny difference between each sample, not mentioned the consumers. That's probably why most wine were rated as 5 or 6. If more extreme cases (below 3 or greater than 8) can be gathered, I would be interested to see why those samples stand out as unique.
